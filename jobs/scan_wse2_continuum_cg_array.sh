...
#SBATCH -c 4
#SBATCH --mem=24G
#SBATCH -o logs/wse2_continuum_cG_%A_%a.out
#SBATCH -e logs/wse2_continuum_cG_%A_%a.err
#SBATCH --requeue
...
OUTPUT_ROOT=${OUTPUT_ROOT:-"results/wse2_cg_nk24_active2_shell5_vp_region"}
...
echo "Running WSe2 continuum c_G task ${TASK_ID}/${TOTAL_TASKS} into ${OUTPUT_ROOT}"
...
echo "python scripts/scan_wse2_continuum_cg.py --output-root ${OUTPUT_ROOT} --merge-only"
