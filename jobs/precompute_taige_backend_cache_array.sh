#!/bin/bash
#SBATCH -J taige_ivc_cache
#SBATCH -p serial_requeue
#SBATCH --array=0-440
#SBATCH -t 24:00:00
#SBATCH -c 4
#SBATCH --mem=24G
#SBATCH -o logs/taige_ivc_cache_%A_%a.out
#SBATCH -e logs/taige_ivc_cache_%A_%a.err
#SBATCH --requeue
...
python scripts/precompute_taige_backend_cache.py \
