#!/bin/bash
#SBATCH -J taige_ivc_hyst_merge
#SBATCH -p serial_requeue
#SBATCH -t 01:00:00
#SBATCH -c 4
#SBATCH --mem=8G
#SBATCH -o logs/taige_ivc_hyst_merge_%j.out
#SBATCH -e logs/taige_ivc_hyst_merge_%j.err
#SBATCH --requeue
...
python scripts/merge_taige_ivc_hysteresis_sweep.py \
