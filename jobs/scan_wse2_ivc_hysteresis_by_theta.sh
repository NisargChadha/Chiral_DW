#!/bin/bash
#SBATCH -J wse2_ivc_hyst
#SBATCH -p serial_requeue
#SBATCH --array=0-41
#SBATCH -t 24:00:00
#SBATCH -c 4
#SBATCH --mem=24G
#SBATCH -o logs/wse2_ivc_hyst_%A_%a.out
#SBATCH -e logs/wse2_ivc_hyst_%A_%a.err
#SBATCH --requeue
...
echo "Running WSe2 IVC hysteresis branch task ${TASK_ID}/${TOTAL_TASKS} into ${OUTPUT_ROOT}"
